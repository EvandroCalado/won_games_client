...
describe('Heading', () => {
  ...
  it('should render a heading with a line bottom when line Bottom primary is passed', () => {
    ...
    expect(screen.getByRole('heading')).toHaveClass(
      'relative after:border-b-4 after:border-b-primary after:absolute after:left-0 after:-bottom-1 after:w-[10%]',
    );
  });
  ...
  it('should render a heading with a line bottom when line Bottom secondary is passed', () => {
    ...
    expect(screen.getByRole('heading')).toHaveClass(
      'relative after:border-b-4 after:border-b-secondary after:absolute after:left-0 after:-bottom-1 after:w-[10%]',
    );
  });
